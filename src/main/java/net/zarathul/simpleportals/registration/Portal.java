...
//		if (nbt == null) return;
//
//		Identifier dimensionLocation = Identifier.parse(nbt.getString("dimension").get());
//		dimension = ResourceKey.create(Registries.DIMENSION, dimensionLocation);
//
//		address = new Address();
//		address.deserializeNBT(nbt.getCompound("address").get());
//
//		axis = Axis.byName(nbt.getString("axis").get());
//
//		corner1 = new Corner();
//		corner1.deserializeNBT(nbt.getCompound("corner1").get());
//
//		corner2 = new Corner();
//		corner2.deserializeNBT(nbt.getCompound("corner2").get());
//
//		corner3 = new Corner();
//		corner3.deserializeNBT(nbt.getCompound("corner3").get());
//
//		corner4 = new Corner();
//		corner4.deserializeNBT(nbt.getCompound("corner4").get());
//	}
